...
Segment.prototype.onidentify = function(identify) {
  var json = mergeBlockedTraits(identify);
  this.enqueue('/i', json);
};
...
Segment.prototype.ongroup = function(group) {
  var json = mergeBlockedTraits(group);
  this.enqueue('/g', json);
};
...
function mergeBlockedTraits(msg) {
  var options = msg.options() || {};
  var json = msg.json() || {};
  if (options.blockedTraits && json.traits) {
    extend(json.traits, options.blockedTraits);
  }
